...
namespace rsc { namespace patterns {
  ...
  namespace detail {
    ...
    template <typename Key,
	      ...
	      typename Accessor>
    struct pair_adapter {
      typedef detail::pair<Key,
			   typename Accessor::result_type> result_type;

      result_type
      operator()(const std::pair<Key, Mapped>& pair) const throw () {
	return
	  make_pair<Key,
	            typename Accessor::result_type>(pair.first,
  ...
  public:
    ...
    typedef
    typename boost::remove_reference<typename Accessor::result_type>::type
                                                mapped_type;

    typedef
    detail::pair_adapter<typename Container::key_type,
			 typename Container::mapped_type,
			 Accessor>              base_accessor_type;
    typedef ContainerProxy<Container,
			    base_accessor_type> base_type;
  ...
  AssociativeProxy<Container,
		   Accessor>::AssociativeProxy(Container& container)
    : base_type(container) {
  }

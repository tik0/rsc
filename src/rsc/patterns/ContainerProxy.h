...
namespace rsc { namespace patterns {
  ...
  public:
    ...
    typedef
    boost::transform_iterator<Accessor,
  ...
  template <typename Container,
	    typename Accessor>
  typename ContainerProxy<Container, Accessor>::const_iterator
  ContainerProxy<Container, Accessor>::begin() const throw () {
  ...
  template <typename Container,
	    typename Accessor>
  typename ContainerProxy<Container, Accessor>::iterator
  ContainerProxy<Container, Accessor>::begin() throw () {
  ...
  template <typename Container,
	    typename Accessor>
  typename ContainerProxy<Container, Accessor>::const_iterator
  ContainerProxy<Container, Accessor>::end() const throw () {
  ...
  template <typename Container,
	    typename Accessor>
  typename ContainerProxy<Container, Accessor>::iterator
  ContainerProxy<Container, Accessor>::end() throw () {
  ...
  template <typename Container,
	    typename Accessor>
  typename ContainerProxy<Container, Accessor>::size_type
  ContainerProxy<Container, Accessor>::size() const throw () {
  ...
  template <typename Container,
	    typename Accessor>
  bool
  ContainerProxy<Container, Accessor>::empty() const throw () {
  ...
  ContainerProxy<Container, pass_through>::begin() const throw () {
    return container.begin();
  }

  template <typename Container>
  typename ContainerProxy<Container, pass_through>::iterator
  ContainerProxy<Container, pass_through>::begin() throw () {
    return container.begin();
  }

  template <typename Container>
  typename ContainerProxy<Container, pass_through>::const_iterator
  ContainerProxy<Container, pass_through>::end() const throw () {
    return container.end();
  }

  template <typename Container>
  typename ContainerProxy<Container, pass_through>::iterator
  ContainerProxy<Container, pass_through>::end() throw () {
    return container.end();
  }

  template <typename Container>
  typename ContainerProxy<Container, pass_through>::size_type
  ContainerProxy<Container, pass_through>::size() const throw () {
    return container.size();
  }

  template <typename Container>
  bool
  ContainerProxy<Container, pass_through>::empty() const throw () {

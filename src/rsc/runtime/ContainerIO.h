...
namespace std {
  ...
  operator<<(basic_ostream<Ch, Tr>&           stream,
    ...
    if (stream.pword(detail::pair_style::stream_storage))
      delete reinterpret_cast<detail::pair_style*>
	(stream.pword(detail::pair_style::stream_storage));
    else
  ...
  operator<<(basic_ostream<Ch, Tr>& stream,
    ...
    detail::pair_style& style = *reinterpret_cast<detail::pair_style*>
      (stream.pword(detail::pair_style::stream_storage));

    stream << style.open_brace
	   << pair.first
	   << style.separator
	   << pair.second
	   << style.close_brace;
  ...
  operator<<(basic_ostream<Ch, Tr>& stream,
    ...
    stream << "{";
    for (typename container_type::const_iterator it

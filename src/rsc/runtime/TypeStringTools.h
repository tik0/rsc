...
namespace rsc { namespace runtime {
  ...
  type_string(const std::string& known_type_string,
	      ...
	      const T&           value) throw (boost::io::format_error);
...
namespace rsc { namespace runtime {
  ...
  template <typename T>
  std::string
  do_type_string(const std::string& known_type_string,
		 const std::string&,
		 const T&	    value,
		 boost::true_type) throw (boost::io::format_error) {
    return (boost::format(known_type_string) % value).str();
  }

  template <typename T>
  std::string
  do_type_string(const std::string&,
		 const std::string& unknown_type_string,
		 const T&,
		 boost::false_type) throw (boost::io::format_error) {
  ...
  type_string(const std::string& known_type_string,
	      const std::string& unknown_type_string,
	      const T&           value) throw (boost::io::format_error) {
    return do_type_string(known_type_string,
			  unknown_type_string,
			  value,
